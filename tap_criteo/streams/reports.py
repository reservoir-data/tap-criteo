...
_type_func_mapping: dict[str, Callable[[str], Any]] = {
    "integer": int,
    "number": Decimal,
}
...
value_func_mapping: dict[str, Callable[[str], Any]] = {
    "Date": _parse_date,
    **{
        field: _type_func_mapping[schema["type"]]
        for field, schema in analytics_type_mappings.items()
        if schema["type"] in _type_func_mapping
    },
}
